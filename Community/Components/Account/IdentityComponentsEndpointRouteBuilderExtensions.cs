...
using TodoSuite.Server.Components.Account.Pages;
using TodoSuite.Server.Components.Account.Pages.Manage;
...
namespace Microsoft.AspNetCore.Routing
{
    internal static class IdentityComponentsEndpointRouteBuilderExtensions
    {
        ...
        private static string GetSafeLogoutRedirect(string? returnUrl)
        {
