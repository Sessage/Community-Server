...
public sealed class CommunityPortfolioSharingService : IPortfolioSharingService
{
    ...
    public Task<string?> GetShareLinkQrCodeAsync(string requestingUserId, Guid portfolioGroupId, Guid inviteId, CancellationToken ct = default) => Task.FromResult<string?>(null);
